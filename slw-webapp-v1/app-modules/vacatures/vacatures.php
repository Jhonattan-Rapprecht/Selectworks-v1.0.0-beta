...
<head>
    ...
    <!-- Page Styles -->
    <link rel="stylesheet" href="/slw-webapp-v1/app-modules/vacatures/vacatures-style.css">
</head>
...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="/vacatures">Vacatures</a></li>
                </ul>
        ...
        <?php 
            for ($x = 1; $x <= 10; $x++) {
                ...
                <div class="vacancy-post">
                    <p><img src="" alt="Afbeelding bedrijf" class="border" style="background-color:#FFF"></p>
                    <h2 class="border" style="background-color:#FFF">Titel / Dit is vacature nummer: '.$x.'</h2>
                    <p class="border" style="background-color:#FFF">
                    ...
                    <p class="border" style="background-color:#FFF">Knoppen: Contact, Solliciteren knop</p>
                </div>';
            }
        ?>
    ...
    <footer class="text-center" style="margin-top:40px;">
        ...
        <p>
            ...
            Website ontwikkeld door: <a href="http://codeflowers.nl"><b>codeflowers.nl</b></a>
        </p>
    </footer>
